...
efficaces. Le problème SAT est cependant $NP$-complet,
\demo{$NP$-complétude du problème SAT}
donc sous l'hypothèse $P\neq NP$, il n'existe pas d'algorithme le résolvant
dans le cas général en temps polynomial. On s'intéresse donc à des cas
particuliers.
